...
import gng1Dark from '~/assets/gng_1_dark.svg?url';
import gng2Dark from '~/assets/gng_2_dark.svg?url';
import gng3Dark from '~/assets/gng_3_dark.svg?url';
import gng1Light from '~/assets/gng_1_light.svg?url';
import gng2Light from '~/assets/gng_2_light.svg?url';
import gng3Light from '~/assets/gng_3_light.svg?url';
import gng1MobileDark from '~/assets/gng_1_mobile_dark.svg?url';
import gng2MobileDark from '~/assets/gng_2_mobile_dark.svg?url';
import gng3MobileDark from '~/assets/gng_3_mobile_dark.svg?url';
import gng1MobileLight from '~/assets/gng_1_mobile_light.svg?url';
import gng2MobileLight from '~/assets/gng_2_mobile_light.svg?url';
import gng3MobileLight from '~/assets/gng_3_mobile_light.svg?url';
    ...
    return (
      <div className={styles.details}>
        ...
        <div className={styles.button} data-visible={visible}>
          <Button iconHoverShift href={buttonLink} iconEnd="arrow-right" className={styles.actionButton}>
            {buttonText}
          </Button>
        </div>
      </div>
